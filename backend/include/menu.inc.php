...
$leftMenu['allmember'] = array(
	...
	'allmember_collect'=>array('title'=>'全权会员列表','url'=>'index.php?action=allmember&h=collect'),
	'allmember_expireCollect'=>array('title'=>'是否过期全权会员列表','url'=>'index.php?action=allmember&h=expireCollect'),
