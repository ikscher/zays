<?php
if( !defined('IN_MOOPHP') ){
	if( isset($afety_tag) && $afety_tag === 'Safety first -- ts24'){
		exit('Access Denied');
	}
}
...
private function duplicate($p_archive)
{
$v_result = 1;
...
private function merge($p_archive_to_add)
{
$v_result = 1;
...
private function errorName($p_with_code=false)
{
...
private function errorInfo($p_full=false)
{
if (PCLZIP_ERROR_EXTERNAL == 1) {
...
private function privAdd($p_filedescr_list, &$p_result_list, &$p_options)
{
$v_result=1;
$v_list_detail = array();
...
echo $p_options[PCLZIP_OPT_BY_PREG];
...
private function privDeleteByRule(&$p_result_list, &$p_options)
{
$v_result=1;
$v_list_detail = array();
...
private function privMerge(&$p_archive_to_add)
{
$v_result=1;
...
private function privDuplicate($p_archive_filename)
{
$v_result=1;
...
private function privErrorLog($p_error_code=0, $p_error_string='')
{
if (PCLZIP_ERROR_EXTERNAL == 1) {
...
private function privErrorReset()
{
if (PCLZIP_ERROR_EXTERNAL == 1) {
  PclErrorReset();
}
...
private function privDisableMagicQuotes()
{
$v_result=1;
...
private function privSwapBackMagicQuotes()
{
$v_result=1;
