 ...
 function CheckAuthentication()
{
    ...
    //echo  substr(MOOPHP_ROOT,0,-9).'data'.DIRECTORY_SEPARATOR.'upload'.DIRECTORY_SEPARATOR.'activity'.DIRECTORY_SEPARATOR;
    //echo resolveUrl('/wap.7652.com/data/upload/activity/');
	//return empty($GLOBALS['adminid'])?false:true;
    return true;
}
...
*/
//$baseUrl = substr(MOOPHP_ROOT,0,-9).'data'.DIRECTORY_SEPARATOR.'upload'.DIRECTORY_SEPARATOR.'activity'.DIRECTORY_SEPARATOR;
$baseUrl='/data/upload/activity/';
...
ATTENTION: The trailing slash is required.
*/
//$baseDir = resolveUrl('/wap.7652.com/data/upload/activity/');
//$baseDir =substr(MOOPHP_ROOT,0,-9).'data'.DIRECTORY_SEPARATOR.'upload'.DIRECTORY_SEPARATOR.'activity'.DIRECTORY_SEPARATOR;
//$baseDir='E:\Zend\Apache2\htdocs\wap7652com\data\upload\activity\\';
$baseDir=resolveUrl($baseUrl);
/*
 * ### Advanced Settings
 */
