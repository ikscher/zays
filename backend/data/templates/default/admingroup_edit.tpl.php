...
<table cellspacing='1' id="list-table">
 <tr>
    ...
    <td>
        <input type="text" name="groupname" id="groupname" value="<?php echo $group['groupname'];?>"/><span class="require-field">*</span>
    </td>
 </tr>
 <tr>
    <td width="18%" valign="top" class="first-cell">
    ...
    <td>
        <textarea name="groupdesc" id="groupdesc" style="width:400px;"><?php echo $group['groupdesc'];?></textarea><span class="require-field">*</span>
    </td>
 </tr>
...
<?php foreach((array)$menu_nav_arr as $key=>$navname) {?>
	...
	<tr>
   		<td width="18%" valign="top" class="first-cell">
    		<input name="adminnav[]" type="checkbox" value="<?php echo $key;?>" id="<?php echo $key;?>_action_check" onclick="check('<?php echo $key;?>_action');" <?php if(in_array($key,$nav)) echo "checked='checked'";?> class="checkbox"><?php echo $navname;?></td>
      	<td id="<?php echo $key;?>_action">
  			<?php foreach((array)$actiondata as $admin_action) {?>
        	<div style="width:200px;float:left;">
    		<label for="<?php echo $admin_action['actioncode'];?>"><input type="checkbox" name="action_code[]" value="<?php echo $admin_action['actioncode'];?>" <?php if(in_array($admin_action['actioncode'],$action)) echo "checked='checked'";?> id="<?php echo $admin_action['actioncode'];?>" class="checkbox"/>
