...
<table>
   <tbody>
    <tr>
     ...
     <td style="width: 25%;"><input type="text" value="<?php echo $story['name1'];?>" id="x1" name="x1" disabled="disabled"/></td>
     <td style="width: 20%;"><b>恋爱另一方:</b></td>
     <td><input type="text" value="<?php echo $story['name2'];?>" name="width" disabled="disabled"/></td>
    </tr>
    <tr>
     <td style="width: 20%;"><b>故事标题:</b></td>
     <td style="width: 25%;"><input type="text" value="<?php echo $story['title'];?>" id="x1" name="x1" disabled="disabled"/></td>
     <td style="width: 20%;"><b>甜蜜进程:</b></td>
     <td><input type="text" value="<?php if($story['state']==1) echo "恋爱";if($story['state']==2) echo "订婚";if($story['state']==3) echo "结婚";?>" name="width" disabled="disabled"/></td>
    </tr>
    <tr>
    <td style="width:20%;"><b>故事内容:</b></td>
     <td colspan="3"><div style="width:400px; height:100px; float:left;overflow-y:scroll; border:#cccccc solid 1px;word-break:break-all;"><?php echo $story['content'];?></div></td>
    </tr>
    <tr <?php if($story['recommand']==1)echo "style=\"display:none\"";?>>
		<td colspan="4">
		<a href="#" id="recommand" onClick="recommand(<?php echo $story['sid'];?>)">推荐到首页</a>
    </tr>
    <tr <?php if($story['syscheck']==1)echo "style=\"display:none\"";?>><input type="hidden" value="<?php echo $id;?>" name="id" /><input type="hidden" value="<?php echo $uid;?>" name="uid" />
     <td colspan="4"><input class="submit" type="submit" name="nopass" value="不通过"/>&nbsp;&nbsp;&nbsp;&nbsp;<input name="pass" class="submit" type="submit" value="通过"/></td>
    </tr>
   </tbody>
  </table>
  </form>
