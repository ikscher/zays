...
<h1>
	<span class="action-span1"><a href="###">真爱一生网 管理中心</a> </span><span id="search_id" class="action-span1"> - 到期高级会员列表</span>
	<span class="action-span"><a href="index.php?action=vipuser&h=high">刷新</a></span>
...
<span class="action-span-day"><a href='?action=vipuser&h=high&afterday=<?php echo date("Y-m-d",strtotime("+1 day"));?>'>今天到期</a></span>
<?php for($i=2;$i<=$current_day+1;$i++) {?>
	<span class="action-span-day"><a href='?action=vipuser&h=high&afterday=<?php echo date("Y-m-d",strtotime("+$i day"));?>'><?php echo ($i-1);?>天到期</a></span>
<?php } ?>
</div>
<p/>
