...
//����ķ���
$names = array('login', 'index', 'register', 'lostpasswd', 'inputpwd','sns', 'viewspace', 'relatekw', 'ajax', 'seccode', 'sendmail', 'myaccount','service','lovestyle','loveing','payment','space','activity');
