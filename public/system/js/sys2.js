...
var reportmessage = new Array('-1,请选择您举报的原因','1,虚假照片','2,虚假信息','3,发送骚扰邮件','4,线上言行不检','5,其它原因');
...
//year(年份)
var years = new Array("1991","1990","1989","1988","1987","1986","1985","1984","1983","1982","1981",
...
function getYearsSelect(classStyle,id,name,realValue,defaultValue){
	...
	for(i=0;i<years.length;i++){
		...
		if(realValue!=null&&realValue!=''&&realValue==years[i]){
			...
			//alert(eval(defaultValue)==years[i]);
...
//生成月份下拉框
function getMonthsSelect(classStyle,id,name,realValue,defaultValue){
	var htmlStr = '<select class="'+classStyle+'" id="'+id+'" name="'+name+'">';
	htmlStr = htmlStr + '<option value="0">请选择</option>';
	for(i=0;i<months.length;i++){
		var selected = '';
		if(realValue!=null&&realValue!=''&&realValue==months[i]){
			selected = 'selected="selected"';
		}else if(realValue==null||realValue==''){
			if(defaultValue==months[i]){
				selected = 'selected="selected"';
			}
		}
		htmlStr = htmlStr + '<option value="'+months[i]+'" '+selected+'>'+months[i]+'</option>';
	}
	htmlStr = htmlStr + '</select>';
	document.write(htmlStr);
}
...
function getDaysSelect(classStyle,id,name,realValue,defaultValue){
	var htmlStr = '<select onfocus="checkDay(\'year\',\'month\',\'day\')" class="'+classStyle+'" id="'+id+'" name="'+name+'">';
	htmlStr = htmlStr + '<option value="0">请选择</option>';
...
function checkDay(yearid,monthid,dayid){
	switch($("#"+monthid).val()){
		case '2':
			if(($("#"+yearid).val()%4 == 0 && $("#"+yearid).val()%100 != 0) && (($("#"+yearid).val()%100!=0) || ($("#"+yearid).val()%400==0))){
				$("#"+dayid+" option").remove("option[value='30']");
				$("#"+dayid+" option").remove("option[value='31']");
			}else{
				$("#"+dayid+" option").remove("option[value='29']");
				$("#"+dayid+" option").remove("option[value='30']");
				$("#"+dayid+" option").remove("option[value='31']");
			}
			break;
		...
		case '11':
			$("#"+dayid+" option").remove("option[value='31']");
			//$("#"+dayid+" option:last-child").remove();
			break;
		default:
			$("#"+dayid+" option").remove("option[value='29']");
			$("#"+dayid+" option").remove("option[value='30']");
			$("#"+dayid+" option").remove("option[value='31']");
			$("#"+dayid).append('<option value="29">29</option>');
			$("#"+dayid).append('<option value="30">30</option>');
			$("#"+dayid).append('<option value="31">31</option>');
			break;
	}
}

//投诉原因
var warnreason = new Array("-1,请选择您的举报原因","1,虚假照片","2,虚假信息","3,发送骚" + "扰邮件","4,线上言行不检","99,其它原因");

//婚姻 new Array("0,请选择","0,保密","1,未婚","2,已婚","3,离异","4,丧偶","5,分居");
...
//会员类型
var membertype = new Array("0,请选择","1,普通会员","2,真爱一生通会员");
...
//在意Ta吸烟吗
var smoking = new Array("-1,请选择","1,都可以","2,在意");
var smokingbuxian = new Array("-1,不限","1,都可以","2,在意");
...
//公司类别
var corptype = new Array("0,请选择","1,政" + "府机关","2,事业单位","3,世界500强","4,外资企业","5,上市公司","6,国营企业","7,私营企业","8,自有公司");
...
//身高
var height = new Array("0,请选择","154,155以下","155,155","156,156","157,157","158,158","159,159","160,160","161,161","162,162","163,163","164,164","165,165","166,166","167,167","168,168","169,169","170,170","171,171","172,172","173,173","174,174","175,175","176,176","177,177","178,178","179,179","180,180","181,181","182,182","183,183","184,184","185,185","186,186","187,187","188,188","189,189","190,190","191,191","192,192","193,193","194,194","195,195","196,196","197,197","198,198","199,199","200,200","201,200以上");
var heightbuxian = new Array("0,不限","154,155以下","155,155","156,156","157,157","158,158","159,159","160,160","161,161","162,162","163,163","164,164","165,165","166,166","167,167","168,168","169,169","170,170","171,171","172,172","173,173","174,174","175,175","176,176","177,177","178,178","179,179","180,180","181,181","182,182","183,183","184,184","185,185","186,186","187,187","188,188","189,189","190,190","191,191","192,192","193,193","194,194","195,195","196,196","197,197","198,198","199,199","200,200","201,200以上");

//体重
var weight = new Array("0,请选择","39,40以下","40,40","41,41","42,42","43,43","44,44","45,45","46,46","47,47","48,48","49,49","50,50","51,51","52,52","53,53","54,54","55,55","56,56","57,57","58,58","59,59","60,60","61,61","62,62","63,63","64,64","65,65","66,66","67,67","68,68","69,69","70,70","71,71","72,72","73,73","74,74","75,75","76,76","77,77","78,78","79,79","80,80","81,81","82,82","83,83","84,84","85,85","86,86","87,87","88,88","89,89","90,90","91,91","92,92","93,93","94,94","95,95","96,96","97,97","98,98","99,99","100,100","101,101","102,102","103,103","104,104","105,105","106,106","107,107","108,108","109,109","110,110","111,111","112,112","113,113","114,114","115,115","116,116","117,117","118,118","119,119","120,120","121,120以上");
var weightbuxian = new Array("0,不限","39,40以下","40,40","41,41","42,42","43,43","44,44","45,45","46,46","47,47","48,48","49,49","50,50","51,51","52,52","53,53","54,54","55,55","56,56","57,57","58,58","59,59","60,60","61,61","62,62","63,63","64,64","65,65","66,66","67,67","68,68","69,69","70,70","71,71","72,72","73,73","74,74","75,75","76,76","77,77","78,78","79,79","80,80","81,81","82,82","83,83","84,84","85,85","86,86","87,87","88,88","89,89","90,90","91,91","92,92","93,93","94,94","95,95","96,96","97,97","98,98","99,99","100,100","101,101","102,102","103,103","104,104","105,105","106,106","107,107","108,108","109,109","110,110","111,111","112,112","113,113","114,114","115,115","116,116","117,117","118,118","119,119","120,120","121,120以上");

//男体形
var body0 = new Array("0,请选择","1,一般","2,瘦长","3,运动员型","4,比较胖","5,体格魁梧","10,矮壮结实","11,皮肤白皙","15,黝黑健康","16,眉清目秀","17,浓眉大眼","0,保密");
var body0buxian = new Array("0,不限","20,保密","1,一般","2,瘦长","3,运动员型","4,比较胖","5,体格魁梧","10,矮壮结实","11,皮肤白皙","15,黝黑健康","16,眉清目秀","17,浓眉大眼");

//女体形
var body1 = new Array("0,请选择","1,一般","2,瘦长","6,苗条","7,高大美丽","8,丰满","9,富线条美","11,皮肤白皙","12,长发飘飘","13,时尚卷发","14,干练短发","20,保密");
var body1buxian = new Array("0,不限","20,保密","1,一般","2,瘦长","6,苗条","7,高大美丽","8,丰满","9,富线条美","11,皮肤白皙","12,长发飘飘","13,时尚卷发","14,干练短发");
//性格
var nature = new Array("0,请选择","1,幽默开朗","2,浪漫感性","3,精明能干","4,乐观积极","5,热情豪爽","6,爱心多多","7,活泼大方","8,浪漫感性","9,认真理性","10,感慨大方","11,成熟稳重","12,多愁善感","13,温柔贤惠","14,婉约含蓄","15,保密");
var naturebuxian = new Array("0,不限","15,保密","1,幽默开朗","2,浪漫感性","3,精明能干","4,乐观积极","5,热情豪爽","6,爱心多多","7,活泼大方","8,浪漫感性","9,认真理性","10,感慨大方","11,成熟稳重","12,多愁善感","13,温柔贤惠","14,婉约含蓄");

var countrybuxian = new Array("0,不限","10100000,中国","10500000,美国","10600000,加拿大","10700000,日本","10800000,澳大利亚","10900000,英国","11000000,法国","11100000,德国","11200000,俄罗斯","11300000,新西兰","11400000,泰国","11500000,马来西亚","11600000,印度尼西亚","11700000,菲律宾","11800000,新加坡","11900000,韩国","12000000,缅甸","12100000,越南","12200000,柬埔寨","12300000,老挝","12400000,印度","12500000,文莱","12600000,巴基斯坦","12700000,朝鲜","12800000,尼泊尔","12900000,斯里兰卡","13000000,土耳其","13100000,乌克兰","13200000,意大利","13300000,芬兰","13400000,荷兰","13500000,挪威","13600000,葡萄牙","13700000,西班牙","13800000,瑞典","13900000,瑞士","14000000,阿根廷","14100000,巴西","14200000,智利","14300000,墨西哥","14400000,秘鲁","14500000,奥地利","14600000,比利时","14700000,丹麦","14800000,希腊","14900000,匈牙利","15000000,哥伦比亚","15100000,委内瑞拉","15200000,爱尔兰","15300000,保加利亚","15400000,冰岛","15500000,卢森堡","15600000,罗马尼亚","15700000,以色列","15800000,埃及","15900000,南非","16000000,奥克兰","16100000,喀麦隆","16200000,毛里求斯","16300000,马达加斯加","16400000,其它地区");
//国家
var country = new Array("0,不限","10100000,中国","10500000,美国","10600000,加拿大","10700000,日本","10800000,澳大利亚","10900000,英国","11000000,法国","11100000,德国","11200000,俄罗斯","11300000,新西兰","11400000,泰国","11500000,马来西亚","11600000,印度尼西亚","11700000,菲律宾","11800000,新加坡","11900000,韩国","12000000,缅甸","12100000,越南","12200000,柬埔寨","12300000,老挝","12400000,印度","12500000,文莱","12600000,巴基斯坦","12700000,朝鲜","12800000,尼泊尔","12900000,斯里兰卡","13000000,土耳其","13100000,乌克兰","13200000,意大利","13300000,芬兰","13400000,荷兰","13500000,挪威","13600000,葡萄牙","13700000,西班牙","13800000,瑞典","13900000,瑞士","14000000,阿根廷","14100000,巴西","14200000,智利","14300000,墨西哥","14400000,秘鲁","14500000,奥地利","14600000,比利时","14700000,丹麦","14800000,希腊","14900000,匈牙利","15000000,哥伦比亚","15100000,委内瑞拉","15200000,爱尔兰","15300000,保加利亚","15400000,冰岛","15500000,卢森堡","15600000,罗马尼亚","15700000,以色列","15800000,埃及","15900000,南非","16000000,奥克兰","16100000,喀麦隆","16200000,毛里求斯","16300000,马达加斯加","16400000,其它地区");

//省份
var provice = new Array("10102000,北京","10103000,上海","10101201,深圳","10101002,广州","10101000,广东","10104000,天津","10105000,重庆","10106000,安徽","10107000,福建","10108000,甘肃","10109000,广西","10110000,贵州","10111000,海南","10112000,河北","10113000,河南","10114000,黑龙江","10115000,湖北","10116000,湖南","10117000,吉林","10118000,江苏","10119000,江西","10120000,辽宁","10121000,内蒙古","10122000,宁夏","10123000,青海","10124000,山东","10125000,山西","10126000,陕西","10127000,四川","10128000,西藏","10129000,新疆","10130000,云南","10131000,浙江","10132000,澳门","10133000,香港","10134000,台湾","2,国外");
...
* obj 列表框
*/
function addElement(text,value,obj){
var selectobj = obj;
...
* arrayObj 对应的数组
*/
function getSelect(classStyle,id,name,realValue,defaultValue,arrayObj){
	var htmlStr = '<select  class="'+classStyle+'" id="'+id+'" name="'+name+'">';
	for(i=0;i<arrayObj.length;i++){
		var selected = '';
		var valueArray = arrayObj[i].split(",");
		if(realValue!=null&&realValue!=''&&realValue==valueArray[0]){
			selected = 'selected="selected"';
		}else if(realValue==null||realValue==''){
			if(defaultValue==valueArray[0]){
				selected = 'selected="selected"';
			}
		}
		htmlStr = htmlStr + '<option value="'+valueArray[0]+'" '+selected+'>'+valueArray[1]+'</option>';
	}
	htmlStr = htmlStr + '</select>';
	document.write(htmlStr);
}
/**********************************寻找对象性别不可选************************************/
function getSelectSex(classStyle,id,name,realValue,defaultValue,arrayObj){
	var htmlStr = '<select disabled class="'+classStyle+'" id="'+id+'" name="'+name+'">';
	for(i=0;i<arrayObj.length;i++){
		var selected = '';
		var valueArray = arrayObj[i].split(",");
		if(realValue!=null&&realValue!=''&&realValue==valueArray[0]){
...
/**********************************寻找对象性别不可选************************************/
/** 清空省份、城市下拉菜单 **/
function clear1(obj2,obj3,title)
	{
		try{																
			var len1 = obj2.options.length;
			var len2 = obj3.options.length;
			for(i=1;i<=len1;i++){
				obj2.remove(0);
			}
			for(i=1;i<=len2;i++){
			...
			obj2.options.add(new Option(title,"0"));
			obj3.options.add(new Option(title,"0"));
		}catch(e){
		}
	}
	
/** 清空城市下拉菜单 **/	
function clear2(obj2,title)
	{
		try{								
...
* arrayObj 对应的数组
*/
function getCountrySelect(classStyle,id,name,provinceid,cityid,realValue,defaultValue){
	var htmlStr = '<select  class="'+classStyle+'" id="'+id+'" name="'+name+'"   onchange="changeProvinceSelect(this.value,\''+provinceid+'\',\''+cityid+'\');">';
	for(i=0;i<country.length;i++){
		var selected = '';
		var valueArray = country[i].split(",");
		if(realValue!=null&&realValue!=''&&realValue!='0'){
			var countrystr = realValue.substring(0,3)+"00000";
			if(countrystr==valueArray[0]){
				selected = 'selected="selected"';
			}
		}else if(realValue==null||realValue==''||realValue=='0'){
			if(defaultValue==valueArray[0]){
				selected = 'selected="selected"';
			}
		}
...
* arrayObj 对应的数组
*/
function getCountrySelectbuxian(classStyle,id,name,provinceid,cityid,realValue,defaultValue){
	var htmlStr = '<select  class="'+classStyle+'" id="'+id+'" name="'+name+'"   onchange="changeProvinceSelectbuxian(this.value,\''+provinceid+'\',\''+cityid+'\');">';
	for(i=0;i<countrybuxian.length;i++){
		var selected = '';
		var valueArray = countrybuxian[i].split(",");
		if(realValue!=null&&realValue!=''&&realValue!='0'){
			var countrystr = realValue.substring(0,3)+"00000";
			if(countrystr==valueArray[0]){
				selected = 'selected="selected"';
...
function changeProvinceSelect(objVale,provinceid,cityid){
	var provinceobj = document.getElementById(provinceid);
	var cityobj = document.getElementById(cityid);
	clear1(provinceobj,cityobj,'请选择');
	for(i=0;i<provice.length;i++){
		var valueArray = provice[i].split(",");
		var countrystr = valueArray[0].substring(0,3)+"00000";
		if(countrystr==objVale){
			provinceobj.options.add(new Option(valueArray[1],valueArray[0]));
		}
	}
}
function changeProvinceSelectbuxian(objVale,provinceid,cityid){
	var provinceobj = document.getElementById(provinceid);
	var cityobj = document.getElementById(cityid);
	clear1(provinceobj,cityobj,'不限');
	for(i=0;i<provice.length;i++){
		var valueArray = provice[i].split(",");
		var countrystr = valueArray[0].substring(0,3)+"00000";
		if(countrystr==objVale){
...
function changeCitySelect(objVale,cityid){
	var cityobj = document.getElementById(cityid);
	clear2(cityobj,'请选择');
	for(i=0;i<city.length;i++){
		var valueArray = city[i].split(",");
		var provincestr = valueArray[0].substring(0,5)+"000";
		if(provincestr==objVale){
			cityobj.options.add(new Option(valueArray[1],valueArray[0]));
		}
	}
}
//通过省份获得 所有城市 标签
...
//linkcalss 链接的样式
//sex 链接的性别属性
function choiceGetCity(objVale,cityid,linkcalss,sex){
	var cityobj = document.getElementById(cityid);
	cityobj.innerHTML = '';
	var str = '';
	for(i=0;i<city.length;i++){
		...
		var provincestr = valueArray[0].substring(0,5)+"000";
		if(provincestr==objVale){
			str += "<li><a class='"+linkcalss+"' href='?n=search&h=tag&tagname=city&s="+sex+"&m=js&tagid="+valueArray[0]+"&linktag="+escape(valueArray[1])+"'>"+valueArray[1]+"</a>|</li> ";
		}
	}
	//document.write(str);
	cityobj.innerHTML = str;
}
function changeCitySelectbuxian(objVale,cityid){
	var cityobj = document.getElementById(cityid);
	clear2(cityobj,'不限');
	for(i=0;i<city.length;i++){
		var valueArray = city[i].split(",");
...
* arrayObj 对应的数组
*/
function getProvinceSelect(classStyle,id,name,cityid,realValue,defaultValue){
	var htmlStr = '<select  class="'+classStyle+'" id="'+id+'" name="'+name+'"   onchange="changeCitySelect(this.value,\''+cityid+'\');">';
	for(i=0;i<provice.length;i++){
		var selected = '';
		var valueArray = provice[i].split(",");
		if(i==0){
		...
		if(valueArray[0]!=null&&valueArray[0]!=''&&valueArray[0]!='0'){//vlaue不为0时
			if(realValue!=null&&realValue!=''&&realValue!='0'){//当前地区value不为0
				var countrystr = realValue.substring(0,3)+"00000";//当前国家value
				var countryValueArray = valueArray[0].substring(0,3)+"00000";//数组value对应的国家value
				var provincestr = realValue.substring(0,5)+"000";//省份value
				if(provincestr==valueArray[0]){//与当前省份一致是被选择
					selected = 'selected="selected"';
				}
				if(countryValueArray==countrystr){
					htmlStr = htmlStr + '<option value="'+valueArray[0]+'" '+selected+'>'+valueArray[1]+'</option>';
				}
			}else if(realValue==null||realValue==''||realValue=='0'){
				if(defaultValue!=null&&defaultValue!=''||defaultValue!='0'){
					var countrystr = defaultValue.substring(0,3)+"00000";//当前国家value
					var countryValueArray = valueArray[0].substring(0,3)+"00000";//数组value对应的国家value
...
* arrayObj 对应的数组
*/
function getProvinceSelectbuxian(classStyle,id,name,cityid,realValue,defaultValue){
	var htmlStr = '<select  class="'+classStyle+'" id="'+id+'" name="'+name+'"   onchange="changeCitySelectbuxian(this.value,\''+cityid+'\');">';
	for(i=0;i<provice.length;i++){
		var selected = '';
		var valueArray = provice[i].split(",");
		if(i==0){
			htmlStr = htmlStr + '<option value="0">不限</option>';
		}
		if(valueArray[0]!=null&&valueArray[0]!=''&&valueArray[0]!='0'){//vlaue不为0时
			if(realValue!=null&&realValue!=''&&realValue!='0'){//当前地区value不为0
				var countrystr = realValue.substring(0,3)+"00000";//当前国家value
...
* arrayObj 对应的数组
*/
function getCitySelect(classStyle,id,name,realValue,defaultValue){
	var htmlStr = '<select  class="'+classStyle+'" id="'+id+'" name="'+name+'">';
	for(i=0;i<city.length;i++){
		var selected = '';
		var valueArray = city[i].split(",");
		...
		if(valueArray[0]!=null&&valueArray[0]!=''&&valueArray[0]!='0'){//vlaue不为0是
			if(realValue!=null&&realValue!=''&&realValue!='0'){//当前地区value不为0
				...
				var citystr = realValue;//城市value
				if(citystr==valueArray[0]){//与当前城市一致时被选择
					selected = 'selected="selected"';
				}
				...
				if(defaultValue!=null&&defaultValue!=''||defaultValue!='0'){
					var provincestr = defaultValue.substring(0,5)+"00000";//当前默认省份value
					var provinceValueArray = valueArray[0].substring(0,5)+"00000";//数组value对应的默认省份value
					var citystr = defaultValue;//城市value
					if(citystr==valueArray[0]){//与当前城市一致时被选择
						selected = 'selected="selected"';
					}
					if(provinceValueArray==provincestr){
...
* arrayObj 对应的数组
*/
function getCitySelectbuxian(classStyle,id,name,realValue,defaultValue){
	var htmlStr = '<select  class="'+classStyle+'" id="'+id+'" name="'+name+'">';
	for(i=0;i<city.length;i++){
		var selected = '';
		var valueArray = city[i].split(",");
...
//喜爱的地方
var fondplaces = new Array("0,请选择","1,都市","2,村庄","3,小镇","4,山区","5,办公室/学校","6,游乐场","7,购物中心","8,我家/我的房间","9,海滨","10,岛屿","11,沙漠","12,雪野","13,图书馆/书店","14,展览馆","15,宗" + "教圣地","16,古迹","17,森林","18,公园","19,咖啡厅/酒吧","20,动物园","21,夜市赶集","22,各种俱乐部","23,其他");
//语言能力
...
* arrayObj 对应的数组
*/
function getCheckbox(id,name,realValue,arrayObj){
	var htmlStr = '';
	for(i=1;i<arrayObj.length;i++){
		...
		htmlStr = htmlStr + '<input id="'+id+'" name="'+name+'" type="checkbox" value="'+valueArray[0]+'" '+selected+'/>'+valueArray[1];
	}
	document.write(htmlStr);
}
...
* arrayObj 对应的数组
*/
function getCheckbox33(id,name,realValue,arrayObj,q){
	var htmlStr = '';
	for(i=1;i<arrayObj.length;i++){
		var selected = '';
		var valueArray = arrayObj[i].split(",");
		...
		htmlStr = htmlStr + '&nbsp;<input id="'+id+i+'" name="'+name+'" type="checkbox" onclick="changeBox(document.hs.'+id+i+',document.hs.'+q+');" value="'+valueArray[0]+'" '+selected+'/>&nbsp;<label for="'+id+i+'">'+valueArray[1]+'</label>&nbsp;&nbsp;';
	}
	document.write(htmlStr);
}
...
* arrayObj 对应的数组
*/
function getCheckbox55(id,name,realValue,arrayObj,q){
	...
	for(i=1;i<arrayObj.length;i++){
		...
		htmlStr = htmlStr + '<span  class="span_right"><input id="'+id+i+'" name="'+name+'" type="checkbox"  onclick="changeBox(document.hs.'+id+i+',document.hs.'+q+');" value="'+valueArray[0]+'" '+selected+'/>&nbsp;<label for="'+id+i+'">'+valueArray[1]+'</label></span>';
...
* arrayObj 对应的数组
*/
function getCheckbox66(id,name,realValue,arrayObj){
	...
	for(i=1;i<arrayObj.length;i++){
		...
		htmlStr = htmlStr + '<span style="margin-left:12px;"><input id="'+id+i+'" name="'+name+'" type="checkbox" value="'+valueArray[0]+'" '+selected+'/>&nbsp;<label for="'+id+i+'">'+valueArray[1]+'</label></span>';
...
* arrayObj 对应的数组
*/
function getCheckbox88(id,name,realValue,arrayObj,q){
	...
	for(i=1;i<arrayObj.length;i++){
		...
		htmlStr = htmlStr + '<li><input id="'+id+i+'" name="'+name+'" type="checkbox" onclick="changeBox(document.hs.' + id + i +',document.hs.' + q + ')" value="'+valueArray[0]+'" '+selected+'/>&nbsp;<label for="'+id+i+'">'+valueArray[1]+'</label></li>';
...
* arrayObj 对应的数组
*/
function getCheckbox43rdsok(id,name,realValue,arrayObj){
	var htmlStr = '';
	for(i=0;i<arrayObj.length;i++){
		var selected = '';
		var valueArray = arrayObj[i].split(",");
		...
		htmlStr = htmlStr + '<li><input id="'+id+'" name="'+name+'" type="checkbox" value="'+valueArray[0]+'" '+selected+'/>'+valueArray[1]+'</li>';
	}
	document.write(htmlStr);
}

function getProvinceSelect66(classStyle, id, name, cityid, realValue, defaultValue) {
	var htmlStr = "<select class=\"" + classStyle + "\" id=\"" + id + "\" name=\"" + name + "\"   onchange=\"changeCitySelect43rds(this.value,'" + cityid + "');\">";
	for (i = 0; i < provice.length; i++) {
		var selected = "";
		var valueArray = provice[i].split(",");
		if (i == 0) {
		...
		if (valueArray[0] != null && valueArray[0] != "" && valueArray[0] != "0") {//vlaue不为0时
			...
			else if (valueArray[0] != null && valueArray[0] != '' && valueArray[0] == '2') {
				htmlStr = htmlStr + "<option value=\"" + valueArray[0] + "\" " + selected + ">" + valueArray[1] + "</option>";
...
function changeCitySelect43rds(objVale, cityid) {
	var cityobj = document.getElementById(cityid);
	clear2(cityobj, '不限');
	//changeWorkcitycountry("10100000",document.sech.workcitycountry);
	...
	if (objVale == "2") {
		for (i = 0; i < city.length; i++) {
			...
			if (provincestr != "101" && valueArray[0]!="0") {
				//cityobj.options.add(new Option(valueArray[1], valueArray[0]));
				addElement(valueArray[1],valueArray[0],cityobj);

			}
		}
		//cityobj.options.remove(0);
		//移除国外不限
		var firstchild=cityobj.firstChild;
...
function getCitySelect66(classStyle,id,name,realValue,defaultValue){
	var htmlStr = '<select  class="'+classStyle+'" id="'+id+'" name="'+name+'">';
	if((defaultValue == '0'||defaultValue == '')&& (realValue == '0'||realValue == '')){
		htmlStr = htmlStr + '<option value="0">不限</option>';
	   	htmlStr = htmlStr + '</select>';
	    document.write(htmlStr);
		return;
	...
	for(i=0;i<city.length;i++){
		var selected = '';
		var valueArray = city[i].split(",");
		if(i==0 && realValue.substring(0,3)=='101'){
			htmlStr = htmlStr + '<option value="0">不限</option>';
		}
		if(valueArray[0]!=null&&valueArray[0]!=''&&valueArray[0]!='0'){//vlaue不为0是
			if(realValue!=null&&realValue!=''&&realValue!='0'&&realValue.substring(0,3)!='101'){//当前地区value不为0
