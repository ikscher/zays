(function($) {
    $.fn.loopedSlider = function(options) {
        ...
        this.each(function() {
            ...
            $('.previous', obj).mouseover(function() {
                if (u === false) {
                    animate('prev', true);
                    if (o.autoStart) {
                        clearInterval(sliderIntervalID)
            ...
            if (o.containerClick) {
                $(o.container, obj).mouseover(function() {
                    if (u === false) {
                        animate('next', true);
                        if (o.autoStart) {
                            clearInterval(sliderIntervalID)
            ...
            $(pagination, obj).mouseover(function() {
			 ...
			 $(pagination, obj).mouseout(function() {
				clearInterval(sliderIntervalID);
