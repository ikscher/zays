...
class kuaiqian
{
   ...
   function get_code($order, $payment)
   {
       ...
       $page_url           = get_payurl("r","kuaiqian");
       $bg_url             = get_payurl("n","kuaiqian");
       $version            = 'v2.0';
       $language           = 1;
       ...
       $order_time         = date('YmdHis');                                 //商户订单提交时间 不可空 14位
       ...
       $pid                = '';
        ...
        $def_url .= "<input type='submit' name='submit' class=\"c_btn\" value='立即使用快钱支付' />";
        $def_url .= "</form></div></br>";
