<?php
    /*
	  ...
	  'msg' => string '' (length=0)
	  'is_lost' => int 0
	  'nickname' => string 'mi' (length=2)
	  'gender' => string '男' (length=3)
	  'province' => string '安徽' (length=6)
	  'city' => string '合肥' (length=6)
	  'year' => string '1999' (length=4)
	  'figureurl' => string 'http://qzapp.qlogo.cn/qzapp/101152005/416D299BC430458B58083591E0AD891A/30' (length=73)
	  'figureurl_1' => string 'http://qzapp.qlogo.cn/qzapp/101152005/416D299BC430458B58083591E0AD891A/50' (length=73)
	  'figureurl_2' => string 'http://qzapp.qlogo.cn/qzapp/101152005/416D299BC430458B58083591E0AD891A/100' (length=74)
	  'figureurl_qq_1' => string 'http://q.qlogo.cn/qqapp/101152005/416D299BC430458B58083591E0AD891A/40' (length=69)
	  'figureurl_qq_2' => string 'http://q.qlogo.cn/qqapp/101152005/416D299BC430458B58083591E0AD891A/100' (length=70)
	...
	*/
    function login_qq(){
	    ...
	    $qqinfo=MooGetGPC('qqinfo','string','P');//返回的Json 字符数据
		...
		if(!empty($qquser['uid'])){
		    ...
		    exit('login_before_with_your_qq');
		}
		...
		$updatetime = time ();
		$sql = "INSERT INTO {$dbTablePre}members_search SET  nickname='{$nickname}',password='{$password}', regdate='{$timestamp}', gender='{$fm}',  province='{$workprovince}', city='{$workcity}', `usertype`=4, birthyear='{$birthyear}',updatetime='{$updatetime}'";
	...
	*/
	function getOpenID(){
	    $accessToken=MooGetGPC('access_token','string','G');
	...
	*/
	function getUserInfo(){
	    $accessToken=MooGetGPC('accessToken','string','G');
		$appid=MooGetGPC('appid','string','G');
		$openid=MooGetGPC('openid','string','G');
