...
<link href="module/space/templates/war/space.css" rel="stylesheet" type="text/css" />
...
<body>
	...
	<div class="head">
		<div class="head-top">
            ...
            <?php if($GLOBALS['MooUid']) { ?>
                <div class="topmsg">欢迎您 <span><?php echo MooCutstr($GLOBALS["user_arr"]['nickname'],8,'')?></span> ，您是今天第 <span class="f-000-a"><?php echo MooLogin();?></span>  位登陆用户</div>
				<div class="topmsg">您的ID是 <span><?php echo $GLOBALS["user_arr"]['uid'];?></span> <a href="index.php?n=service&h=message">最新邮件</a>（<span><?php echo $message_total = header_show_total($GLOBALS["user_arr"]['uid']);?></span>） <a href="index.php?n=material&h=password">修改密码</a> <a href="./index.php?n=index&h=logout">安全退出</a></div>		</div>
			<?php } else { ?>
	...
	<!-- <div class="searchbar">
		...
		<div class="search-cts">
            ...
            <input type="submit" id="quick_search" name="" class="search-btn" style="width:110px;" value="" />
      </form>
	</div> -->
		...
		<div class="c-right">
			...
			<div class="c-rightbox">
				<div class="right-title"><?php if($userid == $uid) { ?><a href="index.php?n=material&h=show" class="f-ed0a91-a">修改</a><?php } ?><div class="right-title-icon"></div><span class="r-title">相册</span></div>
            ...
            <?php } ?>
			<div class="c-rightbox">
				<div class="right-title"><?php if($userid == $uid) { ?><a href="index.php?n=material&h=upinfo#person_message">修改</a><?php } ?><div class="right-title-icon"></div><span class="r-title">基本资料</span></div>
				<div class="rightbox-in">
					<ul class="dtable">
			...
			<div class="c-rightbox">
				<div class="right-title"><?php if($userid == $uid) { ?><a href="index.php?n=material&h=upinfo&#choose_person">修改</a><?php } ?><div class="right-title-icon"></div><span class="r-title">择偶要求</span></div>
				<div class="rightbox-in">
					<ul class="dtable">
			...
			<div class="c-rightbox">
				<div class="right-title"><?php if($userid == $uid) { ?><a href="index.php?n=material&h=upinfo&actio=2">修改</a><?php } ?><div class="right-title-icon"></div><span class="r-title">生活方式</span></div>
				<div class="rightbox-in">
					<ul class="dtable">
			...
			<div class="c-rightbox">
				<div class="right-title"><?php if($userid == $uid) { ?><a href="index.php?n=material&h=upinfo&actio=3">修改</a><?php } ?><div class="right-title-icon"></div><span class="r-title">兴趣爱好</span></div>
				<div class="rightbox-in">
			...
			<div class="c-rightbox">
				<div class="right-title"><?php if($userid == $uid) { ?><a href="index.php?n=material&h=upinfo&#person_introduce">修改</a><?php } ?><div class="right-title-icon"></div><span class="r-title">内心独白</span></div>
				<div class="rightbox-in">
					<p class="my-heart">
