	...
	<div class="content-right">
		<div class="c-right-content">
			...
			<div class="service-title">
				<ul>
					<li><a href="#"  id="two1" onclick="setTab('two',1,4)" class="onthis"><span>谁留意过我（<?php echo $total;?>）</span></a></li>
					<li><a href="#"  id="two2" onclick="setTab('two',2,4)"><span>我留意过谁（<?php echo $tome;?>）</span></a></li>
				</ul>
				<div class="clear"></div>
			</div>
			<!--====公共头部结束==-->
				...
				<ul class="service-liker-list">
					...
					<li>
						...
						<?php if(!empty($visitor['s']['city_star'])) { ?><a class="citystar2"><img src="module/service/templates/default/images/citystar.gif" /></a><?php } ?>
							<div class="r-s-img-in">
								<p style="width:105px;"> <a style="display:block;" href="index.php?n=space&h=viewpro&uid=<?php echo $visitor['l']['uid'];?>" target="_blank">
					...
					<li class="fright">
						<dl class="r-service-heart">
							...
							<dd>
								<p>浏览时间：<span class="f-ed0a91"><?php echo date("Y年m月d日 ",$visitors['visitortime']);?></span></p></dd>
						</dl>	
					</li>
				</ul>
				<?php } ?>
