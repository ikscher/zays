...
<link href="module/space/templates/travelworld/space.css" rel="stylesheet" type="text/css" />
...
<body>
	<div class="center">
		...
		<div class="content">
			<div class="c-right">
				<div class="c-rightbox" style="margin:0;">
				...
				<div class="c-rightbox">
					<div class="right-title"><?php if($userid == $uid) { ?><a href="index.php?n=material&h=show" class="fright  f-ed0a91-a">修改</a><?php } ?><span class="r-title">相册</span></div>
					<div class="rightbox-in r-boxbg01">
            	...
            	<?php } ?>
				<div class="c-rightbox">
					<div class="right-title"><?php if($userid == $uid) { ?><a href="index.php?n=material&h=upinfo#person_message" class="fright f-ed0a91-a">修改</a><?php } ?><span class="r-title">基本资料</span></div>
				...
				<div class="c-rightbox">
					<div class="right-title"><?php if($userid == $uid) { ?><a href="index.php?n=material&h=upinfo&#choose_person" class="fright f-ed0a91-a">修改</a><?php } ?><span class="r-title">择偶要求</span></div>
				...
				<div class="c-rightbox">
					<div class="right-title"><?php if($userid == $uid) { ?><a href="index.php?n=material&h=upinfo&actio=2" class="fright f-ed0a91-a">修改</a><?php } ?><span class="r-title">生活方式</span></div>
				...
				<div class="c-rightbox">
					<div class="right-title"><?php if($userid == $uid) { ?><a href="index.php?n=material&h=upinfo&actio=3" class="fright f-ed0a91-a">修改</a><?php } ?><span class="r-title">兴趣爱好</span></div>
				...
				<div class="c-rightbox">
					<div class="right-title"><?php if($userid == $uid) { ?><a href="index.php?n=material&h=upinfo&#person_introduce" class="fright f-ed0a91-a">修改</a><?php } ?><span class="r-title">内心独白</span></div>
