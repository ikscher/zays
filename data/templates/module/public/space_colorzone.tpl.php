...
<link href="module/space/templates/colorzone/space.css" rel="stylesheet" type="text/css" />
	...
	<div class="main">
		...
		<div class="content">
			<div class="c-right">
            	...
            	<?php } ?>
				<div class="c-rightbox">
					<div class="right-title r-box02"><?php if($userid == $uid) { ?><a href="index.php?n=material&h=upinfo#person_message">修改</a><?php } ?><span class="r-title">基本资料</span></div>
					<div class="r-side side02"></div>
					<div class="rightbox-in r-box-bg02">
						<ul class="dtable">
				...
				<div class="c-rightbox">
					<div class="right-title r-box03"><?php if($userid == $uid) { ?><a href="index.php?n=material&h=upinfo&#choose_person">修改</a><?php } ?><span class="r-title">择偶要求</span></div>
					<div class="r-side side03"></div>
					<div class="rightbox-in r-box-bg03">
						<ul class="dtable">
				...
				<div class="c-rightbox">
					<div class="right-title r-box04"><?php if($userid == $uid) { ?><a href="index.php?n=material&h=upinfo&actio=2">修改</a><?php } ?><span class="r-title">生活方式</span></div>
					<div class="r-side side04"></div>
					<div class="rightbox-in r-box-bg04">
						<ul class="dtable">
				...
				<div class="c-rightbox">
					<div class="right-title r-box05"><?php if($userid == $uid) { ?><a href="index.php?n=material&h=upinfo&actio=3">修改</a><?php } ?><span class="r-title">兴趣爱好</span></div>
					<div class="r-side side05"></div>
					<div class="rightbox-in r-box-bg05">
						<p style="margin-top:10px;">喜欢的运动：<?php $fda = explode(",",$user['fondsport']);?>
				...
				<div class="c-rightbox">
					<div class="right-title r-box06"><?php if($userid == $uid) { ?><a href="index.php?n=material&h=upinfo&#person_introduce">修改</a><?php } ?><span class="r-title">内心独白</span></div>
					<div class="r-side side06"></div>
					<div class="rightbox-in r-box-bg06">
						<p class="my-heart">
                         <?php $u = MooGetGPC('uid','integer');?>
                            <?php if(!$u) { ?>
                                ...
                                <?php } elseif ($c['introduce_check'] != '') { ?>
                                    ...
                                    （<font class="f-3065b5-a" style="text-decoration:none;">正在审核中</font>）
                                <?php } else { ?>
