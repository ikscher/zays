...
<link href="module/search/templates/<?php echo $GLOBALS['style_name'];?>/search.css" type="text/css" rel="stylesheet" />
</style>
...
<script>getSelect('','a1','age_start','<?php echo $age_start;?>','21',agebuxian);</script>
至&nbsp;
<script>getSelect('','a2','age_end','<?php echo $age_end;?>','45',agebuxian);</script>
</p>
</dd>
...
<?php $user_arr['city'] = 0?>
<?php } ?>
	<script>getProvinceSelect43rds('','workprovince2','workprovince','workcity2',"<?php echo $GLOBALS['user_arr']['province'];?>",'10100000');</script>
	<script>getCitySelect43rds('','workcity2','workcity',"<?php echo $GLOBALS['user_arr']['city'];?>",'');</script>
</p>
...
<!-- <?php if($search_arr) { ?> -->
<?php foreach((array)$search_arr as $k=>$v) {?>
<option value="<?php echo $v['scid'];?>"><?php echo $v['searchsign'];?></option>
<?php }?>
<!-- <?php } ?> -->
</select>
</dt>
