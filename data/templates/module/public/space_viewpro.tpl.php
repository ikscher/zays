	...
	<div class="content-right">
		...
		<div class="rightbox">
			<div class="rightdata">
				...
				<h4>
					<span id="vf_01" class="t01"><?php if($userid == $uid) { ?><a href="index.php?n=material&h=upinfo#person_message" class="f-ed0a91-a">修改</a><?php } ?>基本资料</span>
				
					<span id="vf_02" class="t02"><?php if($userid == $uid) { ?><a href="index.php?n=material&h=upinfo&#choose_person" class="f-ed0a91-a">修改</a><?php } ?>择偶要求</span>
					
					<span id="vf_03" class="t02"><?php if($userid == $uid) { ?><a href="index.php?n=material&h=upinfo&actio=2" class="f-ed0a91-a">修改</a><?php } ?>生活方式</span>
					
					<span id="vf_04" class="t02"><?php if($userid == $uid) { ?><a href="index.php?n=material&h=upinfo&actio=3" class="f-ed0a91-a">修改</a><?php } ?>兴趣爱好</span>
				</h4>	
