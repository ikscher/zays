...
<link href="module/space/templates/seaheart/space.css" rel="stylesheet" type="text/css" />
	...
	<div class="center">
		<div class="head">
            ...
            <?php if($GLOBALS['MooUid']) { ?>
                <div class="topmsg">欢迎您 <span class="f-0b64ab"><?php echo MooCutstr($GLOBALS["user_arr"]['nickname'],8,'')?></span> ，您是今天第 <span class="f-000-a"><?php echo MooLogin();?></span>  位登陆用户</div>
				<div class="topmsg">您的ID是 <span class="f-0b64ab"><?php echo $GLOBALS["user_arr"]['uid'];?></span> <a href="index.php?n=service&h=message" class="f-000-a">最新邮件</a>（<span class="f-0b64ab"><?php echo $message_total = header_show_total($GLOBALS["user_arr"]['uid']);?></span>） <a href="index.php?n=material&h=password" class="f-000-a">修改密码</a> <a href="./index.php?n=index&h=logout" class="f-000-a">安全退出</a></div>
			<?php } else { ?>
            ...
            <div class="topnav">
				...
				<a class="upgrade" href="index.php?n=payment&amp;h=channel_diamond"></a>
			</div>
			<div class="clear"></div>
		</div><!--head end-->
		...
		<!-- <div class="searchbar">
			...
			<div class="search-cts">
				...
				<input type="submit" id="quick_search" name="" class="search-btn" value="" style="width:128px;" />
        	</form>
		</div> -->
		...
		<div class="content">
			...
			<div class="c-right">
                ...
                <?php } ?>
				<div class="c-rightbox">
					<div class="right-title"><?php if($userid == $uid) { ?><a href="index.php?n=material&h=upinfo#person_message" class="fright f-0b64ab-a">修改</a><?php } ?><span class="r-title">基本资料</span></div>
					<div class="rightbox-in">
						<div class="rightbox-in-side">
							<ul class="dtable">
				...
				<div class="c-rightbox">
					<div class="right-title"><?php if($userid == $uid) { ?><a href="index.php?n=material&h=upinfo&#choose_person" class="fright f-0b64ab-a">修改</a><?php } ?><span class="r-title">择偶要求</span></div>
					<div class="rightbox-in">
						<div class="rightbox-in-side">
							<ul class="dtable">
				...
				<div class="c-rightbox">
					<div class="right-title"><?php if($userid == $uid) { ?><a href="index.php?n=material&h=upinfo&actio=2" class="fright f-0b64ab-a">修改</a><?php } ?><span class="r-title">生活方式</span></div>
					<div class="rightbox-in">
						<div class="rightbox-in-side">
							<ul class="dtable">
				...
				<div class="c-rightbox">
					<div class="right-title"><?php if($userid == $uid) { ?><a href="index.php?n=material&h=upinfo&actio=3" class="fright f-0b64ab-a">修改</a><?php } ?><span class="r-title">兴趣爱好</span></div>
					<div class="rightbox-in">
						<div class="rightbox-in-side">
                            <p>喜欢的运动：<?php $fda = explode(",",$user['fondsport']);?>
				...
				<div class="c-rightbox">
					<div class="right-title"><?php if($userid == $uid) { ?><a href="index.php?n=material&h=upinfo&#person_introduce" class="fright f-0b64ab-a">修改</a><?php } ?><span class="r-title">内心独白</span></div>
					<div class="rightbox-in">
						<div class="rightbox-in-side">
							<p class="my-heart">
