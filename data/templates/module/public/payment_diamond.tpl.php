...
<link href="module/payment/templates/default/css.css" rel="stylesheet" type="text/css" />
</head>
<body>
<div class="main">
	<?php include MooTemplate('system/header','public'); ?>
    <div id="vip_content">
	<p class="c-title"><span class="f-000"><a href="index.php">真爱一生首页</a>&nbsp;&gt;&gt;&nbsp;升级钻石会员</span></p>
		<div class="clear"></div>
	
	<div id="vip_ad"><img src="module/payment/templates/default/images/vip_ad.jpg" /><div class="into"><a href="index.php?n=payment&h=channel_diamond"><img src="module/payment/templates/default/images/<?php echo ($s_cid=='20') ? 'goon' : 'vip_button';?>.jpg" /></a></div></div>
    <div id="category">
    	<div class="post">
...
高效的网上寻爱服务，让你轻轻松松找到心仪之人！</dd>
    ...
    爱情的脚步快速临近！</p>
        ...
        <a href="index.php?n=payment&h=channel_diamond" class="into"><img src="module/payment/templates/default/images/<?php echo ($s_cid=='20') ? 'goon' : 'vip_button';?>.jpg" /></a>
    </div>
</div>
