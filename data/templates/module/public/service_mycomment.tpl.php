...
<div class="main">
	...
	<div class="content">
	<p class="c-title"><span class="f-000"><a href="index.php">真爱一生首页</a>&nbsp;&gt;&gt;&nbsp;<a href="index.php?n=service">我的真爱一生</a>&nbsp;&gt;&gt;&nbsp;我的评价</span><a href="index.php?n=invite" target="_blank" class="loaction_right">邀请好友</a></p>
	...
	<div class="content-right">
		<div class="c-right-content">
			...
			<span class="right-title f-ed0a91">我的评价</span>			
			</div>
			<div class="r-center-ccontent" style="padding:20px 0 60px; width:753px;">
				<!--=======公共头部=====-->
				 <form name="form2" action="index.php?n=service&h=delmycomment" method="post"> 
			<div class="service-title">
				<ul>
					<li><a id="two1" href="index.php?n=service&h=mycomment"  <?php if($_GET['h']=='mycomment') { ?>class="onthis"<?php } ?>><span>谁评价过我（<?php echo $total;?>）</span></a></li>
					<li><a href="index.php?n=service&h=mycommentwho" id="two2" <?php if($_GET['h']=='mycommentwho') { ?>class="onthis"<?php } ?>><span>我评价过谁（<?php echo $total2;?>）</span></a></li>
				</ul>
				<div class="clear"></div>
			</div>
			<!--====公共头部结束==-->
            ...
            <?php } else { ?>
			  <?php foreach((array)$comment_list as $comment) {?>
        	  <?php $send_user1 = leer_send_user1($comment['cuid']);?>
					...
					<li>
						...
						<?php if(!empty($send_user1['city_star'])) { ?><a class="citystar2"><img src="module/service/templates/default/images/citystar.gif" /></a><?php } ?>
							<div class="r-s-img-in">
								<p> <a style="display:block;" href="index.php?n=space&h=viewpro&uid=<?php echo $comment['cuid'];?>" target="_blank">
                ...
                <?php } else { ?>
                <?php } ?>
                <a id="fzs" href="index.php?n=space&h=viewpro&uid=<?php echo $send_user1['uid'];?>"><?php $nickname=$send_user1['nickname2']?$send_user1['nickname2']:$send_user1['nickname']?><?php echo $nickname?$nickname:'ID:'.$send_user1['uid']?></a></dt>
					...
					<li class="fright">
						<dl class="r-service-heart">
							<dt>评价内容</dt>
							<dd class="r-service-heart-text"><?php echo $comment['content'];?></dd>
							<dd>
								<p><input name="" type="button" onclick="location.href='index.php?n=service&h=commission&t=sendcontact&sendid=<?php echo $send_user1['uid'];?>'" class="get-know-likes" value="委托真爱一生联系TA" /></p></dd>
						</dl>	
					</li>
				</ul>
				<?php } ?>
				<div class="clear"></div>
				<div class="pages"><span class="fleft" style="padding-left:40px;"><input name="" type="checkbox" value="" onclick="checkAll(this)" />&nbsp;全选<input name="" type="submit" class="my-e-button" value="删除信息" /></span><?php echo multimail($total,$pagesize,$page,$currenturl2)?><input name=""  id="pageGo" type="text" size="3" />&nbsp;<input name="" type="button" class="go-page" value="GO" onclick="gotoPage()" style="float:none"/>
					<div class="clear"></div>
				</div>
				<?php } ?>
			</div>
