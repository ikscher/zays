...
<link href="module/space/templates/red/space.css" rel="stylesheet" type="text/css" />
	...
	<div class="center">
		<div class="head">
            ...
            <?php if($GLOBALS['MooUid']) { ?>
                <div class="topmsg">欢迎您 <span class="f-b90101"><?php echo MooCutstr($GLOBALS["user_arr"]['nickname'],8,'')?> </span> ，您是今天第 <span class="f-000-a"><?php echo MooLogin();?></span>  位登陆用户</div>
				<div class="topmsg">您的ID是 <span class="f-b90101"><?php echo $GLOBALS["user_arr"]['uid'];?></span> <a href="index.php?n=service&h=message" class="f-000-a">最新邮件</a>（<span class="f-b90101"><?php echo $message_total = header_show_total($GLOBALS["user_arr"]['uid']);?></span>） <a href="index.php?n=material&h=password" class="f-000-a">修改密码</a> <a href="./index.php?n=index&h=logout" class="f-000-a">安全退出</a></div>
            <?php } else { ?>
		...
		<!-- <div class="searchbar">
        	<form action="index.php" method="get" onsubmit="return checkquicksearch();">
				...
				<ul class="search-cts-list" id="search_more">
					...
					<li>年龄:<script>getSelect('','age1','agebegin','','21',age);</script>&nbsp;至&nbsp;<script>getSelect('','age2','ageend','','45',age) ;</script></li>
					<li>地区:
                ...
                <input type="submit" id="quick_search" name="" class="search-btn" style="width:115px;" value=" " />
			</form>
        </div> -->
					...
					<div class="rightbox-in">
                        ...
                        <?php if(!$u) { ?>
                            ...
                            <?php } elseif ($c['introduce_check'] != '') { ?>
                                ...
                                （<font class="f-b90101-a" style="text-decoration:none;">正在审核中</font>）
                            <?php } else { ?>
