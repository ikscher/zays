  ...
  <div class="recommendMember">
            ...
            <div class="back face" style="left:100%">
              <div class="proIntro">
                ...
                <div class="text"> 学历： <script>sys.getEducation(<?php echo $u['education'];?>);</script> <br>
                  ...
                  地区：<script>sys.getProvinceValue(<?php echo $u['province'];?>);sys.getCityValue(<?php echo $u['city'];?>);</script> <p class="mt10"><a  class=" ffff" uid="<?php echo $u['uid'];?>" href="space_<?php echo $u['uid'];?>.html" target="_blank">认识 <?php echo $u['gender']?'她':'他';?> >></a> </p></div>
              </div>
            </div>
            <div class="front face" style="left: 0px;"><a href="#"><img src="<?php  echo IMG_SITE.MooGetphoto($u['uid'],'mid');?>" width="120" height="150"></a></div>
          </div>
        </li>
        <?php }?>
      </ul>
    ...
    <div class="upgradeMember">
      <ul>
        ...
        <li><span><?php echo str_replace('您的','',$v_['content'])?><span></li>
        <?php }?>
      </ul>
    </div>
  </div>
  ...
  <div class="vip clearfix">
            ...
            <div class="back face" style="left:100%">
              <div class="proIntro">
                ...
                <div class="text"> 学历：<script>sys.getEducation(<?php echo $vu['education'];?>);</script><br>
                  ...
                  地区：<script>sys.getProvinceValue(<?php echo $vu['province'];?>);sys.getCityValue(<?php echo $vu['city'];?>);</script><p class="mt10"><a  class=" ffff" uid="57088748" href="space_<?php echo $vu['uid'];?>.html" target="_blank">认识 <?php echo $vu['gender']?'她':'他';?>>></a> </p></div>
              </div>
            </div>
    ...
    <div class="bulltinboard">
      <ul>
		...
		<li>升级之后，我还需要支付其他的费用吗？<a href="faq.html">点击查看</a></li>
		<li>我能不能先见面再升级会员？<a href="faq.html">点击查看</a></li>
		<li>我怎么得到女孩子的联系方式？<a href="faq.html">点击查看</a></li>
		<li>我给你们去电话，为什么有时候打不通呢？<a href="faq.html">点击查看</a></li>
