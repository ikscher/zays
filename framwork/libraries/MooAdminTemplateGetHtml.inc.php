...
<link href="./{$param['adminDir']}/css/admin.css" rel="stylesheet" type="text/css" />
...
$leftHtml = <<<EOT
	...
	<html xmlns="http://www.w3.org/1999/xhtml">
		<head>
			...
			<meta http-equiv="Content-Type" content="text/html; charset={$GLOBALS['charset']}">
			<link rel="stylesheet" type="text/css" id="css" href="./{$param['adminDir']}/css/admin.css">
			<script src="./{$param['adminDir']}/javascript/admin.js" type="text/javascript"></script>
			<script>
			var collapsed = getcookie("Moo-collapse");
			function collapse_change(menucount) {
...
<div class="logo" style="font-weight:bold;color:red;">
	您的登录用户名是:{$GLOBALS['username']},ID是:{$GLOBALS['adminid']}
</div>
</td><td>
	<div class="topmenu">
		<ul>
